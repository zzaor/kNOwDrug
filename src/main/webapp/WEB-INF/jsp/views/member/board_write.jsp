        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h2>자유게시판 글 등록</h2>
              <span class="color-text-a">Resister For Community</span>
            </div>
          </div>
        </div>
      </div>
...
<div class="container">
<form method="post" action="board.do" enctype="multipart/form-data" onsubmit="return fn_search()">
	<div class="row">
    	<div class="col-1">
			<p>제목</p>
		</div>
        <div class="col-md-6 mb-3">
        	<div class="form-group">
            	<input type="text" id="title" name="boardTitle" class="search-input w-100" placeholder="게시글 제목" />
			</div>
		</div>
	</div>
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
        	<div class="form-group">
            	<input type="text" name="memId"  class="search-input" value="<%=memName %>" />
			</div>
		</div>
    	<div class="col-1">
			<p>작성일</p>
	...
	<div class="row">
        <div class="col">
        	<div class="form-group">
            	<textarea class="search-text" id="content" name="boardContent" placeholder="   게시물 내용" style="height: 300px;"></textarea>
			</div>
		</div>
	</div>
	<div class="row">
