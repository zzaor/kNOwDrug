...
public class DurSearchPage {
	private int total; // 전체글개수
	private int currentPage; // 현재 페이지번호
	private List<Map<String,Object>> content; // LprodVo 목록 데이터
	private int totalPages; // 전체 페이지수
	private int startPage; // 페이지 시작번호[1]
	private int endPage; // 페이지 종료번호..[5]

	public DurSearchPage(int total, int currentPage, int size, List<Map<String,Object>> content) {
		this.total = total;
